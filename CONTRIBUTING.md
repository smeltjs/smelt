...
| `mcp: guards/tool-surface.test.ts`   | the MCP tool descriptions and instructions growing past the byte ceiling every session pays, or the measurement itself going flat                                                                            |
